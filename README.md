- [Native dual-range input](https://muffinman.io/blog/native-dual-range-input/?utm_source=thecollectivenewsletter.beehiiv.com&utm_medium=referral&utm_campaign=the-collective-885) compose two native range input into a single dual-range #pattern#slider
